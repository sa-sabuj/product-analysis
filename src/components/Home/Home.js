        ...
        <div>
            <section className='header-area grid grid-cols-2 gap-4" m-20'>
                ...
                <div className='img-area ml-7'>
                    <img src="https://i.ibb.co/GvwPpr7/image1.jpg" alt="" />
            ...
            <section>
                ...
                <div className='content-center ml-5'>
                    <button onClick={showAllReviews} className='bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 border border-blue-700 rounded align-middle content-center mb-8'>See More</button>
                </div>
            </section>
        </div>
    );
